...
public class RecordPanel extends BasePanel {
    ...
    private void init(){
		...
		// AVI Option
		addButton(this, "Save as movie (mov)", "Save as .mov movie. Note: NO SPACE in the output file name!, some systems may have trouble opening .mov format files. Please install VLC for playback.", "saveMovie", new Rectangle(10, 180, 170, 20), 12);
